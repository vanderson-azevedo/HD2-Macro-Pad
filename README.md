...
1) Faça o download da ultima versão na guia de [lançamentos](https://github.com/vanderson-azevedo/HD2-Macro-Pad/releases) aqui do GitHub...

2) Execute o aplicativo no seu computador, ele abrirá uma janela informando o **ENDEREÇO DE CONEXÃO**, para você digitar no navegador do dispositivo (Celular ou Tablet).
